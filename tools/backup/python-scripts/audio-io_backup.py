#!/usr/bin/env python3
"""
audio-io_backup.py - create project backup zip and copy to central archive
Usage: python audio-io_backup.py [--project-root PATH] [--archive-root PATH] [--exclude PATH ...] [--dry-run]
"""
...
def main() -> int:
    ...
    default_excludes = ['models', 'docs', 'build', 'install', 'tools/backup', 'backup', 'logs', '.git', '.vs', '.vscode', '__pycache__']

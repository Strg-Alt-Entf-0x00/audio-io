#!/usr/bin/env python3
"""
audio_io_backup.py - create project backup zip and copy to central archive
Usage: python audio_io_backup.py [--project-root PATH] [--archive-root PATH] [--exclude PATH ...] [--dry-run]
"""
...
def main() -> int:
    ...
    default_excludes = ['models', 'docs', 'build', 'install', 'tools/backup', 'backup', 'logs', '.git', '.vs', '.vscode', '__pycache__', 'tools/ai_lab/test_outputs']
